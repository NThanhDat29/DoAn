...
<div class="row d-flex justify-content-md-between mb-3">
  <form method="GET" action="/admin/suppliers/list" class="input-group rounded col-md-8 w-auto align-items-center">
  ...
  <div class="text-md-right col-md-4">
    <a href="/admin/suppliers/add" class="btn-sm btn btn-success text-decoration-none">
      <div class="p-1">
...
<table class="table table-hover table-bordered table-responsive-xl">
  ...
  <tbody>
    {!! \App\Helpers\Supplier\SupplierHelper::supplier($suppliers) !!}
  </tbody>
</table>
