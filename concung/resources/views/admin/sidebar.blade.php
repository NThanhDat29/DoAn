<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:#06283D; position: fixed;">
  ...
  <a href="/admin/" class="text-decoration-none brand-link">
    <img src="/template/admin/dist/img/logo-concung.png" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8; width: 70px; height: auto;">
    <span class="brand-text font-weight-light">Admin Con Cưng</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if ( Auth::user()->usertype_id === 1 || Auth::user()->usertype_id === 2)
        <li class="nav-item pagination">
          <a href="/admin/suppliers/list" class="nav-link {{ request()->is('admin/suppliers/*') ? 'active-sidebar' : '' }}">
            <i class="nav-icon fa-solid fa-trademark"></i>
            <p>Nhà cung cấp</p>
          </a>
        </li>
