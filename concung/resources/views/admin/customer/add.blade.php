  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="housenumber" placeholder="Nhập số nhà khách hàng">
      </div>
      <div class="form-group col-md-6">
        <label>Tỉnh thành</label>
        <select class="form-control form-select" id="province-select" name="province_id">
