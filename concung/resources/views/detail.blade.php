    ...
    <div class="main-detail-head">
      <div class="left">
        ...
        <div class="main-detail-head-name">
          ...
          <p class="mb-2">Thương hiệu: <a href="{{ $product->trademark->url }}" style="color: #ff379b;"><b>{{ $product->trademark->name }}</b></a></p>
      ...
      <div class="right">
        <div class="main-detail-head-company d-flex align-items-center">
          <div class="company-img">
            <img src="/template/img/logo-concung.png" class="img-fluid" alt="">
          </div>
          <h6 class="ms-4 mb-0">CÔNG TY CỔ PHẦN CON CƯNG</h6>
        </div>
