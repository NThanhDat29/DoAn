...
Route::middleware(['auth'])->group(function () {
  Route::prefix('admin')->group(function () {
    ...
    #Supplier
    Route::prefix('suppliers')->middleware('checkUserType2')->group(function () {
      ...
      Route::get('search', [SupplierController::class, 'search'])->name('admin.trademarks.search');
      Route::get('edit/id={trademark}', [SupplierController::class, 'show']);
      Route::post('edit/id={trademark}', [SupplierController::class, 'update']);
    ...
    Route::prefix('orders')->group(function () {
      ...
      Route::post('export-csv', [OrderController::class, 'export_csv'])->name('admin.export-csv');
    });
